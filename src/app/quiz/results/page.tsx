    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <div className="mb-6">
              <h2 className="text-2xl font-semibold text-gray-900">DETAILED QUIZ RESULTS - ALWAYS VISIBLE</h2>
              <p className="text-red-600 font-bold">TEST: If you can see this red text, the deployment worked!</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
              {results.responses.map((response, index) => (
                ...
                >
                  ...
                  <p className="text-sm text-gray-600 truncate" title={response.question}>
                    {response.question}
                  </p>
                </div>
              ))}
